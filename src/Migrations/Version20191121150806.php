 ...
 */
final class Version20191121150806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, title LONGTEXT DEFAULT NULL, customer LONGTEXT DEFAULT NULL, body LONGTEXT DEFAULT NULL, link LONGTEXT DEFAULT NULL, footer LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
