 ...
 */
final class Version20191112140142 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE aanmeld (id INT AUTO_INCREMENT NOT NULL, voornaam LONGTEXT NOT NULL, achternaam VARCHAR(255) NOT NULL, telefoon VARCHAR(255) NOT NULL, doel VARCHAR(255) NOT NULL, contact VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
