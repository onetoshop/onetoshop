 ...
 */
final class Version20191108104151 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image CHANGE image image LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image CHANGE image image LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
