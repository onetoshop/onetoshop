 ...
 */
final class Version20191119111552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app DROP categorie');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app ADD categorie VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
