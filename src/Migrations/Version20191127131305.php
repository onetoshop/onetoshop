 ...
 */
final class Version20191127131305 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aanmeld DROP created_at, CHANGE voorkeur voorkeur VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aanmeld ADD created_at DATETIME NOT NULL, CHANGE voorkeur voorkeur VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE apps CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE blog DROP FOREIGN KEY FK_C01551433DA5256D');
        $this->addSql('DROP INDEX UNIQ_C01551433DA5256D ON blog');
        $this->addSql('ALTER TABLE blog ADD image LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, DROP image_id');
        $this->addSql('ALTER TABLE card CHANGE bgimage_id bgimage_id INT DEFAULT NULL, CHANGE frimage_id frimage_id INT DEFAULT NULL');
