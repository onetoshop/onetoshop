 ...
 */
final class Version20191112153911 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aanmeld ADD email VARCHAR(255) NOT NULL, ADD voorkeur VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aanmeld DROP email, DROP voorkeur');
