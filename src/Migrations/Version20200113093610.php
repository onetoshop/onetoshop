 ...
 */
final class Version20200113093610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps ADD apps_id INT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apps_apps (apps_source INT NOT NULL, apps_target INT NOT NULL, INDEX IDX_EB8446C1FCD83F2B (apps_target), INDEX IDX_EB8446C1E53D6FA4 (apps_source), PRIMARY KEY(apps_source, apps_target)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE apps DROP apps_id, CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE blog CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE card CHANGE bgimage_id bgimage_id INT DEFAULT NULL, CHANGE frimage_id frimage_id INT DEFAULT NULL');
