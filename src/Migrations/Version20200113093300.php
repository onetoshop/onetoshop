 ...
 */
final class Version20200113093300 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps DROP parent_id, CHANGE image_id image_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps ADD parent_id INT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL');
