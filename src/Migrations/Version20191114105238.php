 ...
 */
final class Version20191114105238 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aanmeld ADD created_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE voorkeur voorkeur VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
