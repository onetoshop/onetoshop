 ...
 */
final class Version20191120095442 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps ADD groep VARCHAR(255) NOT NULL, ADD naam VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE blog DROP beschrijving, DROP slug');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD beschrijving LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, ADD slug LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
