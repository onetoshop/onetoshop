 ...
 */
final class Version20191119151509 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps DROP slug');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps ADD slug VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
