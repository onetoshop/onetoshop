 ...
 */
final class Version20191111104353 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD description VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
