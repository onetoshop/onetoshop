 ...
 */
final class Version20191129111516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE functionaliteitinformatie DROP url');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE functionaliteitinformatie ADD url VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE project CHANGE image_id image_id INT DEFAULT NULL');
