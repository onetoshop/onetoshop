 ...
 */
final class Version20191125093442 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, voornaam LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, achternaam LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, email LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, onderwerp LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, bericht LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
