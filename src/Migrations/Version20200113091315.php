 ...
 */
final class Version20200113091315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps ADD beschrijving LONGTEXT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL, CHANGE parentid_id parentid_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps DROP beschrijving, CHANGE image_id image_id INT DEFAULT NULL, CHANGE parentid_id parentid_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE blog CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE card CHANGE bgimage_id bgimage_id INT DEFAULT NULL, CHANGE frimage_id frimage_id INT DEFAULT NULL');
