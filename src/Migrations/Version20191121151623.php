 ...
 */
final class Version20191121151623 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE card ADD bgimage_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE card ADD CONSTRAINT FK_161498D3561DAA52 FOREIGN KEY (bgimage_id) REFERENCES image (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_161498D3561DAA52 ON card (bgimage_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE card DROP FOREIGN KEY FK_161498D3561DAA52');
        $this->addSql('DROP INDEX UNIQ_161498D3561DAA52 ON card');
        $this->addSql('ALTER TABLE card DROP bgimage_id');
