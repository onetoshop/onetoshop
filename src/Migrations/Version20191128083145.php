 ...
 */
final class Version20191128083145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aanmeld ADD beschrijving VARCHAR(255) NOT NULL, CHANGE voorkeur voorkeur VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE functionaliteitinfo ADD tabtitle LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aanmeld DROP beschrijving, CHANGE voorkeur voorkeur VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE apps CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE blog CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE card CHANGE bgimage_id bgimage_id INT DEFAULT NULL, CHANGE frimage_id frimage_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE functionaliteitinfo DROP tabtitle');
