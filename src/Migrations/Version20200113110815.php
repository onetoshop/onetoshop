 ...
 */
final class Version20200113110815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps ADD naam LONGTEXT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL, CHANGE apps_id apps_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps DROP naam, CHANGE image_id image_id INT DEFAULT NULL, CHANGE apps_id apps_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE blog CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE card CHANGE bgimage_id bgimage_id INT DEFAULT NULL, CHANGE frimage_id frimage_id INT DEFAULT NULL');
