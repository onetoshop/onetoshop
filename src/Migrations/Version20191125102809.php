 ...
 */
final class Version20191125102809 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON NOT NULL, CHANGE title title LONGTEXT DEFAULT NULL, CHANGE body body LONGTEXT DEFAULT NULL, CHANGE image image LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin, CHANGE title title LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE body body LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE image image LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
